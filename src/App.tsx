            ...
            <div className="flex justify-between h-16">
              <div className="flex items-center gap-2">
                <div className="w-9 h-9 border-2 border-black rounded-full flex items-center justify-center">
                  <span className="font-bold text-black text-sm tracking-tighter leading-none pb-0.5">
                    go
                  </span>
                </div>
                <span className="text-2xl font-medium text-black tracking-tight">coffee</span>
              </div>
